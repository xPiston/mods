...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket>
{
    ...
    public boolean registerPacket(Class<? extends AbstractPacket> clazz)
    {
        if (this.packets.size() > 256)
        {
            Logger.getLogger(CraftechWeaponry.MODNAME).log(Level.SEVERE,
                    "A Packet length was over the limit of 256 ! Too many bullets in one time !");
            return false;
        }
        ...
        {
            Logger.getLogger(CraftechWeaponry.MODNAME).log(Level.SEVERE,
                    "The Abstract Packet have been registered ! Do not eat your own weapon dammit !");
            return false;
        }
        ...
        {
            Logger.getLogger(CraftechWeaponry.MODNAME).log(Level.SEVERE,
                    "A Packet have been registered in PostInit phase ! Better call saul !");
            return false;
        }
    ...
    {
        this.channels = NetworkRegistry.INSTANCE.newChannel(CraftechWeaponry.MODNAME, this);
        this.registerPackets();
    }

    public void registerPackets()
    {
        registerPacket(WeaponFirePacket.class);
